    ...
    <Card className="mb-4 border-amber-200 bg-amber-50 text-amber-900 dark:border-amber-900/40 dark:bg-amber-950/40 dark:text-amber-200">
      <CardContent className="flex items-center justify-between gap-3 py-2.5">
        ...
        <button
          ...
          className="shrink-0 rounded-full bg-amber-100 px-2.5 py-1 text-xs font-medium text-amber-700 transition-colors hover:bg-amber-200 dark:bg-amber-900/50 dark:text-amber-200 dark:hover:bg-amber-900/70"
        >
          Dismiss
        </button>
      </CardContent>
